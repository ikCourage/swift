package swift.controller.mt
{
	...
	internal class MovieMonitor extends USprite
	{
		static protected var instance:MovieMonitor;
		
		protected var xml:XML;
		protected var theText:TextField;
		protected var fps:int = 0;
		protected var ms:uint;
		protected var lastTimeCheck:uint;
		protected var maxMemory:Number = 0;
		protected var fpsVector:Vector.<Number>;
		protected var childrenCount:int;
		...
		protected function countDisplayList(container:DisplayObjectContainer):void
		{
		...
		static public function getInstance():MovieMonitor
		{
			return null === instance ? instance = new MovieMonitor() : instance;
		}
